...
hi! CursorLineNr cterm=bold ctermbg=254 ctermfg=236 gui=bold guibg=#dee8f2 guifg=#2b333b
...
hi! Todo cterm=NONE ctermbg=194 ctermfg=236 gui=NONE guibg=#cceedd guifg=#2b333b
