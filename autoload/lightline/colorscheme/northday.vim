...
function! s:build_palette() abort
  ...
  let col_base     = ["#808890", "#d5dde5", 245, 253]
  let col_edge     = ["#e6eef6", "#808890", 255, 245]
  let col_gradient = ["#2b333b", "#bcc4cc", 236, 251]
  let col_nc       = ["#808890", "#d5dde5", 245, 253]
  let col_tabfill  = ["#808890", "#d5dde5", 245, 253]
  let col_normal   = ["#e6eef6", "#5588bb", 255, 67]
  let col_error    = ["#e6eef6", "#cc6688", 255, 168]
  let col_warning  = ["#e6eef6", "#aa66cc", 255, 134]
  let col_insert   = ["#e6eef6", "#449999", 255, 30]
  let col_replace  = ["#e6eef6", "#aa66cc", 255, 134]
  let col_visual   = ["#e6eef6", "#7777dd", 255, 104]
  let col_tabsel   = ["#e6eef6", "#808890", 255, 245]
